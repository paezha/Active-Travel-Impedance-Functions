...
Create a table with origins and destinations for walking in 2015. First, I'll identify the rows in the episode file where the location of the activity was "315", which is code for "walking," as well as one row before and after them.
...
Second, I'll select the required columnS (required variables such as PUMFID (Record identification),  : 
```{r}
walking_2015 <- gss_e_2015 |>
  dplyr::slice(unlist(rows)) |>
  dplyr::select(PUMFID,WGH_EPI, LOCATION) |> 
